...
def cadastrar_empresa(request):
    ...
    #To Do - Realizar validação de campos
...
def listar_empresas(request):
    #To Do - VALIDAÇAO SE O USUARIO ESTA LOGADO EM TODAS AS VIEWS
    ...
    if request.method == "GET":
        # To Do - Filtrar empresas ali na busca do listar_empresas(pesquisa de empresa)
...
def empresa(request, id):
    ...
    if request.method == "GET":
        ...
        return render(request, 'empresa.html', {'empresa': empresa, 'documentos': documentos, 'proposta_investimentos_enviada': propostas_investimentos_enviada, 'percentual_vendido': int(percentual_vendido), 'total_captado': total_captado, 'valuation_atual': valuation_atual},)
